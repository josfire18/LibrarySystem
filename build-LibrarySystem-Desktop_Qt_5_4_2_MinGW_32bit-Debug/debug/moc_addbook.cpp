...
#include "../../LibrarySystem/addbook.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddBook_t, stringdata) + ofs \
...
const QMetaObject AddBook::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddBook.data,
      qt_meta_data_AddBook,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddBook::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddBook.stringdata))
        return static_cast<void*>(const_cast< AddBook*>(this));
